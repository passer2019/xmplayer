...
This is a deprecated option, you can use B<raw_format> instead.
...
Pixel format of the framebuffer.  Defaults to B<bgr0>.
...
If set to B<true>, print a list of found/available NDI sources and exit.
Defaults to B<false>.
...
=item B<allow_video_fields>

When this flag is B<false>, all video that you receive will be progressive.
Defaults to B<true>.
